...
_secret_file = join(BASE_DIR,'ocatsite/static/safe/skey')
...
if socket.gethostname() == 'ars':
    ...
    DEBUG = True
    TEMPLATE_DEBUG = True
    ALLOWED_HOSTS = [u'r2d2-v.cfa.harvard.edu']
#
#--- r2d2-v.cfa.harvard.edu is not a secure site and we cannot set te following two parameters
#
...
#    '/data/mta4/CUS/www/Usint/Ocat/ocatsite/templates',
    os.path.join(BASE_DIR, 'ocatsite/templates'),
